...
const images = {
  ...
  clients: "/images/can.png",
  server: "/images/can.png",
    ...
    <div style={{ width: '100%', height: '100%', background: '#253237' }}>
      ...
      <Parallax ref={parallax} pages={5}>
        ...
        <ParallaxLayer offset={1.6} speed={-0.1} style={{ opacity: 0.8 }}>
          ...
          <img src={images.clients} style={{ display: 'block', width: '20%', marginLeft: '80%' }}  className="rotate-45"/>
  ...
  />
        ...
        <ParallaxLayer
          ...
          style={{
            ...
            backgroundImage: `url(${images.clients})`, // Use the custom clients background image URL
          }}
        />
            ...
            <div className={styles.headerContainer}>
                ...
                <p className={`${styles.header1Text} ${styles.headerSize}`}> Fixing melbounres waste problem.Right from your home</p>
        ...
        <ParallaxLayer sticky={{ start: 1.25, end: 1.5}} speed={4}>
            <div className={styles.headerContainer}>
                <h1 className={`${styles.MelbText} ${styles.headerSize1}`}>#4 most liveable city</h1>
            </div>
        </ParallaxLayer>
        ...
        <ParallaxLayer sticky={{ start: 2, end: 2.25}} speed={4}>
            <div >
                <h1 className={`${styles.MelbText} ${styles.headerSize1}`}>population: 5.207 million</h1>
            </div>
        </ParallaxLayer>

        <ParallaxLayer sticky={{ start: 2.75, end: 3}} speed={4}>
            <div>
                <h1 className={`${styles.MelbText} ${styles.headerSize1}`}>3.3 million tonnes of waste</h1>
            </div>
        </ParallaxLayer>

        <ParallaxLayer sticky={{ start: 3.5, end: 3.75 }} speed={4}>
            <div >
                <h1 className={`${styles.MelbText} ${styles.headerSize1}`}>75% ends up in landfills</h1>
            </div>
        </ParallaxLayer>
